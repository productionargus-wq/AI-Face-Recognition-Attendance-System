...
export const RegisterOrg = () => {
  ...
  const handleInitiateGoogleAuth = (e) => {
    e.preventDefault();
  ...
  return (
    <div className="min-h-screen bg-[#f8fbff] bg-blueprint flex flex-col justify-between text-slate-800">
            ...
            <div>
              <div className="mb-6">
                ...
                <p className="text-xs text-slate-500 mt-1">
                  Enter your company details, then continue with Google to initialize your tenant.
                </p>
              </div>
              ...
              <form onSubmit={handleInitiateGoogleAuth} className="space-y-4">
                <div>
      ...
      <GoogleAuthModal
        ...
        promptText={`Register "${formData.name || 'Organisation'}" with your Google Account`}
      />
